...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/wine', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-wine',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_wine', {
            title: title,
            desc: desc,
 ...
 * POST add product
 */
router.post('/add-wine', function (req, res) {
 ...
 * GET edit product
 */
router.get('/edit-wine/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_wine', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-wine/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/wine/edit-wine/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/wine/edit-wine/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-wine/:id', isAdmin, function (req, res) {

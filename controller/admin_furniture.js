...
// Get Product model
var Product = require('../models/furniture');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/furniture', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-furniture',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_furniture', {
            title: title,
            desc: desc,
 ...
 * GET edit product
 */
router.get('/edit-furniture/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_furniture', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-furniture/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/furniture/edit-furniture/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/furniture/edit-furniture/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-furniture/:id', isAdmin, function (req, res) {

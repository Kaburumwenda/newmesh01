...
// Get Product model
var Product = require('../models/golf');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/golf1', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-golf',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_golf', {
            title: title,
            desc: desc,
 ...
 * POST add product
 */
router.post('/add-golf', function (req, res) {
 ...
 * GET edit product
 */
router.get('/edit-golf/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_golf', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-golf/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/golf/edit-golf/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/golf/edit-golf/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-golf/:id', isAdmin, function (req, res) {

...
// Get Product model
var Product = require('../models/phone');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, phones) {
        res.render('adminFeaturedCat/phones', {
           phones:phones,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-phone',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_phone', {
            title: title,
            desc: desc,
 ...
 * GET edit product
 */
router.get('/edit-phone/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_phone', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-phone/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/phones/edit-phone/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/phones/edit-phone/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-phone/:id', isAdmin, function (req, res) {

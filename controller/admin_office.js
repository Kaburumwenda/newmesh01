...
// Get Product model
var Product = require('../models/office');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/office', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-office',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_office', {
            title: title,
            desc: desc,
 ...
 * GET edit product
 */
router.get('/edit-office/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_office', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-office/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/office/edit-office/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/office/edit-office/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-office/:id', isAdmin, function (req, res) {

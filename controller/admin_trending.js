...
// Get Product model
var Product = require('../models/trending');
 ...
 * GET add product
 */
router.get('/add-trending',isAdmin,  function (req, res) {
 ...
 * POST add product
 */
router.post('/add-trending', function (req, res) {
 ...
 * GET edit product
 */
router.get('/edit-trending/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        res.render('admin/edit_trending', {
                            title: p.title,
                            errors: errors,
                            //seller:p.seller,
                            discount:p.discount,
 ...
 * POST edit product
 */
router.post('/edit-trending/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/trending/edit-trending/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/trending/edit-trending/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-trending/:id', isAdmin, function (req, res) {

...
// Get Product model
var Product = require('../models/pets');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/pets', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-pets',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_pets', {
            title: title,
            desc: desc,
 ...
 * GET edit product
 */
router.get('/edit-pets/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_pets', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-pets/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/pets/edit-pets/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/pets/edit-pets/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-pets/:id', isAdmin, function (req, res) {

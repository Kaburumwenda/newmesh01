...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, items) {
        res.render('adminFeaturedCat/laptop', {
           items:items,
            count: count
        });
    });
 ...
 * GET add product
 */
router.get('/add-laptop',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_laptop', {
            title: title,
            desc: desc,
 ...
 * POST add product
 */
router.post('/add-laptop', function (req, res) {
 ...
 * GET edit product
 */
router.get('/edit-laptop/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_laptop', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
 ...
 * POST edit product
 */
router.post('/edit-laptop/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/laptop/edit-laptop/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/laptop/edit-laptop/' + req.query.id);
                }
            });
        }
    });
 ...
 * GET delete product
 */
router.get('/delete-laptop/:id', isAdmin, function (req, res) {

...
// Get Product model
var Product = require('../models/men');
...
router.get('/', isAdmin,  function (req, res) {
    ...
    Product.find(function (err, men) {
        res.render('adminFeaturedCat/men', {
           men:men,
            count: count
        });
    });
...
router.get('/add-men',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('adminFeaturedCat/add_men', {
            title: title,
            desc: desc,
 ...
 * POST add product
 */
router.post('/add-men', function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        galleryImages = files;
                        res.render('adminFeaturedCat/edit_men', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            spec:p.spec,
...
router.post('/edit-men/:id', function (req, res) {
    ...
    if (errors) {
        ...
        res.redirect('/admin/men/edit-men/' + id);
    } else {
        ...
        if (err) {
            ...
            fs.remove(thumbImage, function (err) {
                if (err) {
                    ...
                    res.redirect('/admin/men/edit-men/' + req.query.id);
                }
            });
        }
    });
